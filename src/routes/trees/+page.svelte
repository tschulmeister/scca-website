<script>
    ...
    const images = [
        ...
        {
            src: "/data/img/trees/IMG_4662.jpg",
            title: "Common Area Tree Assessment",
        },
        {
            src: "/data/img/trees/IMG_4666.jpg",
            title: "Common Area Tree Assessment",
        },
    ];
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-5 space-y-4">
            ...
            >
                ...
                <div
                    class="mt-4 p-4 rounded-xl bg-slate-50 border border-slate-100"
                >
            ...
            <div class="rounded-3xl border border-slate-200 bg-slate-50 p-6">
                ...
                <ul class="space-y-3 text-sm text-slate-700 leading-relaxed">
                    <li class="flex gap-2">
                        ...
                        <span
                            >Verify the tree is clearly inside SCCA common
                            areas, not on private homeowner lots.</span
                        >
                    </li>
                    <li class="flex gap-2">
                        <span class="text-blue-500 font-bold">•</span>
                        <span
                            >Check for visual signs of decay: severe leaning,
                            complete loss of bark, hollowed trunks, or large
                            dead overhanging branches.</span
                        >
                    </li>
                    <li class="flex gap-2">
                        <span class="text-blue-500 font-bold">•</span>
                        <span
                            >Provide detailed location references (e.g. house
                            addresses, proximity to trails) when reporting.</span
                        >
                    </li>
                </ul>
            </div>
        ...
        <div class="lg:col-span-7 space-y-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="text-slate-700 mt-2 leading-relaxed">
                            Dead and decaying trees inside common woodland
                            buffers are serious structural hazards. High winds,
                            winter storms, or advanced core decay can cause
                            limbs or entire trees to collapse without warning,
                            resulting in:
                        </p>
                        <ul
                        ...
                        >
                            <li>
                                <strong>Physical Safety Risks:</strong> Threat of
                                injury to residents, children, or pets utilizing our
                                shared paths, trails, and playgrounds.
                            </li>
                            <li>
                                <strong>Homeowner Property Damage:</strong> Threat
                                to border property boundaries, including structural
                                damage to fences, decks, yards, or roofs.
                            </li>
                            <li>
                                <strong>Utility Outages:</strong> Danger to overhead
                                telephone and electrical lines running near wooded
                                paths.
                            </li>
                            <li>
                                <strong>Increased Fire Hazards:</strong> Dry, dead
                                timber increases combustible wood fuel loading inside
                    ...
                    <div>
                        ...
                        <p class="text-slate-700 mt-2 leading-relaxed">
                            SCCA is strictly responsible for trees growing
                            within <strong
                                >official SCCA common properties</strong
                            >.
                        </p>
                        <p class="text-slate-700 mt-2 leading-relaxed">
                            If a dead tree is located entirely within a
                            resident's private lot, it is the homeowner's
                            responsibility to manage and finance its removal.
                            SCCA assessment funds cannot be legally allocated to
                            private property maintenance. If you are uncertain
                            of property lines, please consult the neighborhood
                            Plat Maps on our <a
                                href="/documents"
                    ...
                    <div>
                        ...
                        <p class="text-slate-700 mt-2 leading-relaxed">
                            The SCCA Board coordinates with tree removal
                            contractors to evaluate tree health. Removals are
                            scheduled and prioritized based on proximity to
                            houses or pedestrian paths, and managed within
            ...
            >
                ...
                <p class="text-slate-700 mb-6 leading-relaxed">
                    If you have spotted a dead, dying, or dangerously leaning
                    tree inside an SCCA common area, please notify our Board of
                    Directors to request an inspection.
                </p>
