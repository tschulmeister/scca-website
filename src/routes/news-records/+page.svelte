...
<section class="page-header py-20">
  <div class="max-w-7xl mx-auto px-4 text-center">
    ...
    >
      <a
        href="https://www.shipleyschoice.org/uploads/1/4/6/6/146632212/newsletter_2025.pdf"
        target="_blank"
        rel="noreferrer"
    ...
    <div class="divide-y divide-slate-100">
      <div class="py-6 first:pt-0 last:pb-0 group">
        ...
        >
          ...
          >
            Designating Shipley’s Choice Community Association as a Special
        ...
        >
          ...
          <p>
            ...
            pursuing this action for one reason: <span class="font-bold"
              >only 70 percent of houses that are part of SCCA pay annual dues</span
        ...
        <div class="mt-4 flex gap-2">
          <span
            class="inline-flex items-center rounded-md bg-blue-50 px-2.5 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10"
          >
            Official Notice
          </span>
          <span
      ...
      <div class="py-6 first:pt-0 last:pb-0 group">
        ...
        >
          ...
          <p>
            For more information regarding children and e-scooters, please visit <a
              href="https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/E-Scooters.aspx"
              class="app-link">HealthyChildren.org</a
        ...
        <div class="mt-4 flex gap-2">
          <span
            class="inline-flex items-center rounded-md bg-purple-50 px-2.5 py-1 text-xs font-medium text-purple-700 ring-1 ring-inset ring-purple-700/10"
          >
            Community Safety
          </span>
        </div>
