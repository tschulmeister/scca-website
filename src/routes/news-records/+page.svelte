...
<section
  class="max-w-7xl mx-auto px-4 py-12 grid gap-8 lg:grid-cols-[300px_1fr]"
>
  <aside class="space-y-4">
    <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
      <h2 class="text-2xl font-bold text-slate-900 mb-4">Latest newsletter</h2>
      <p class="text-slate-700 mb-6">
        The most recent community newsletter from the legacy site is available
        as a PDF. If your browser does not support previewing it, download the
        file directly.
      </p>
      <a
