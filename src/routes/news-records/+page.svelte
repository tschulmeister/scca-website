<script>
    ...
    onMount(() => {
        const sections = processedNewsItems.map((item) =>
    ...
    function getItemCategory(item) {
        ...
        if (tags.includes("idea") || title.includes("idea")) {
            return "idea";
        }
        if (
        ...
        switch (category) {
            case "idea":
                return {
                    ...
                    hoverBg:
                        "group-hover:bg-yellow-50 group-hover:border-yellow-300",
                };
            case "safety":
                return {
            ...
            case "finance":
                return {
                    ...
                    hoverBg:
                        "group-hover:bg-emerald-100 group-hover:border-emerald-300",
                };
            case "improvement":
                return {
...
<section class="page-header py-20">
    <div class="max-w-7xl mx-auto px-4 text-center">
        ...
        <p class="mt-4 max-w-2xl mx-auto text-slate-300">
            Download the latest community newsletter and browse community news
            items shared by the board
        </p>
        <div
        ...
        <aside class="hidden lg:block lg:col-span-3">
            <nav class="sticky top-24">
                ...
                <ul class="mt-4 space-y-1 border-l-2 border-slate-100">
                    {#each processedNewsItems as item}
                        <li>
                            <a
                                href="#{item.id}"
                                ...
                                class:hover:border-slate-300={activeId !==
                                    item.id}
                                class:hover:text-slate-700={activeId !==
                                    item.id}
                            >
                                {item.title}
                            </a>
        ...
        <div class="lg:col-span-9">
            ...
            >
                ...
                <div class="mt-6 space-y-8">
                    {#each processedNewsItems as item, i}
                        ...
                        >
                            ...
                            >
                                ...
                                {#if i < processedNewsItems.length - 1}
                                    <div
                                        class="w-[2px] grow bg-slate-100 my-2"
                                    ></div>
                                {/if}
                            </div>
