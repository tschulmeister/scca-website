...
>
    ...
    >
        ...
        >
            <div class="flex flex-row items-center justify-between py-4 gap-4">
                ...
                <div class="flex items-center gap-2 md:hidden shrink-0 ml-auto">
                    ...
                    <button
                        ...
                        class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 bg-slate-800 text-slate-300 hover:bg-slate-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
                        ...
                        {#if link.children}
                            <div class="relative shrink-0">
                                <button
                                    ...
                                    class="inline-flex items-center gap-1 px-3 py-2 text-sm transition-colors duration-150 shrink-0 whitespace-nowrap {activeNavParent ===
                                    link.name
                                ...
                                >
                                    {link.name}
                                    <svg
                                        class="h-4 w-4 transition-transform duration-150 {openDropdown ===
                                        link.name
                                            ? 'rotate-180'
                                            : ''}"
                                        viewBox="0 0 20 20"
                                    ...
                                    >
                                        {#each link.children as child}
                                            <a
                                                ...
                                                on:click={() =>
                                                    (openDropdown = null)}
                                                class="block px-4 py-2 text-sm transition-colors duration-150 {$page
                                                    .url.pathname === child.path
                            ...
                            {#if openDropdown === "more_btn"}
                                ...
                                >
                                    {#each overflowLinks as link}
                                        {#if link.children}
                                            <div
                                                class="px-4 py-1.5 text-xs font-bold text-slate-400 uppercase tracking-wider bg-slate-950/40 border-y border-slate-800"
                                            >
                                                {link.name}
                                            </div>
                                            {#each link.children as child}
                                                <a
                                                    ...
                                                    on:click={() =>
                                                        (openDropdown = null)}
                                                    class="block pl-6 pr-4 py-2 text-sm transition-colors duration-150 {$page
                                                        .url.pathname ===
                                                    child.path
            ...
            {#if navOpen}
                <nav
                    class="md:hidden grid gap-2 border-t border-slate-700 pt-4 pb-4 max-h-[80vh] overflow-y-auto"
                >
                    {#each navLinks as link}
                        {#if link.children}
                            <div>
                                ...
                                {#if openDropdown === link.name + "_mobile"}
                                    <div
                                        class="bg-slate-950/30 pl-4 py-1 border-l-2 border-blue-500/50"
                                    >
                                        {#each link.children as child}
                                            <a
                                                href={child.path}
                                                on:click={() =>
                                                    (navOpen = false)}
                                                class="block px-4 py-2.5 text-sm font-medium transition-colors {$page
                                                    .url.pathname === child.path
                        ...
                        {:else}
                            <a
                                ...
                                class="block px-4 py-3 text-sm font-medium transition-colors {$page
                                    .url.pathname === link.path
                                    ? 'text-blue-400 font-semibold'
    ...
    >
        &copy; {new Date().getFullYear()} Shipley's Choice Community Association.
        All rights reserved.
    </footer>
</div>
